...
/***/ "./src/admin/components/PurgeImagesModal.js":
/*!**************************************************!*\
  !*** ./src/admin/components/PurgeImagesModal.js ***!
  \**************************************************/
...
/* harmony export */   "default": () => (/* binding */ PurgeImagesModal)
/* harmony export */ });
...
var PurgeImagesModal = /*#__PURE__*/function (_Modal) {
  function PurgeImagesModal() {
    return _Modal.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PurgeImagesModal, _Modal);
  var _proto = PurgeImagesModal.prototype;
  ...
  _proto.title = function title() {
    return flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_title");
  };
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_helpText")), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteUnusedLabel")), m("div", {
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteUnusedHelp")), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      icon: "fas fa-trash",
      loading: this.loading && this.purgeType === 'unused',
      disabled: this.loading,
      onclick: function onclick() {
        return _this.purgeImages('unused');
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteUnusedBtnText"))), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteAllLabel")), m("div", {
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteAllHelp")), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--danger",
      icon: "fas fa-trash",
      loading: this.loading && this.purgeType === 'all',
      disabled: this.loading,
      onclick: function onclick() {
        return _this.purgeImages('all');
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteAllBtnText"))), this.output && m("div", {
      className: "Form-group"
    }, m("div", {
      className: "PurgeImages-output"
    }, m("pre", null, this.output))), this.commandOutput.length > 0 && m("div", {
      className: "Form-group"
    }, m("div", {
      className: "PurgeImages-summary"
    }, this.commandOutput.map(function (line, index) {
      return m("div", {
        key: index
      }, line);
    })))));
  };
  _proto.purgeImages = function purgeImages(type) {
    var _this2 = this;
    this.purgeType = type;
    this.loading = true;
    this.output = flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_runningCommand");
    this.commandOutput = [];
    ...
    setTimeout(function () {
      flarum_app__WEBPACK_IMPORTED_MODULE_3___default().request({
        method: 'POST',
        url: flarum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('apiUrl') + '/walsgit/discussion-cards/purge-images' + (type === 'all' ? '?all=true' : '')
      }).then(function (result) {
        _this2.loading = false;
        _this2.output = result.command + "\n";
        _this2.commandOutput = result.output;
        m.redraw();

        // Show success message
        flarum_app__WEBPACK_IMPORTED_MODULE_3___default().alerts.show({
          type: 'success'
        }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_success"));
      })["catch"](function (err) {
        _this2.loading = false;
        _this2.output = flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_error");
        _this2.commandOutput = [err.message || flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_unknownError")];
        m.redraw();

        // Show error message
        flarum_app__WEBPACK_IMPORTED_MODULE_3___default().alerts.show({
          type: 'error'
        }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_error"));
      });
    }, 500); // 500ms delay to see the running message
  };
  return PurgeImagesModal;
}((flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_1___default()));


/***/ }),

/***/ "./src/admin/components/RegenerateImagesModal.js":
/*!*******************************************************!*\
  !*** ./src/admin/components/RegenerateImagesModal.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RegenerateImagesModal)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/common/components/Modal */ "flarum/common/components/Modal");
/* harmony import */ var flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_1__);
...
var RegenerateImagesModal = /*#__PURE__*/function (_Modal) {
  function RegenerateImagesModal() {
    return _Modal.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(RegenerateImagesModal, _Modal);
  var _proto = RegenerateImagesModal.prototype;
  _proto.oninit = function oninit(vnode) {
    _Modal.prototype.oninit.call(this, vnode);
    this.loading = false;
    this.output = "";
  ...
  _proto.title = function title() {
    return flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_title");
  };
  _proto.content = function content() {
    var _this = this;
    return m("div", {
      ...
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_helpText"), m("a", {
      href: "https://github.com/WalsGit/flarum-discussion-cards/wiki/CLI-Commands#discussion-cardsregenerate-images",
      target: "_blank"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_helpTextUrlTitle"), ".")), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLatestLabel")), m("div", {
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLatestHelp")), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
      loading: this.loading && this.regenerateType === 'latest',
      disabled: this.loading,
      onclick: function onclick() {
        return _this.regenerateImages('latest');
      }
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLatestBtnText"))), m("div", {
      className: "Form-group"
    }, m("label", null, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLTNOLabel")), m("div", {
      className: "helpText"
    }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLTNOHelp")), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_2___default()), {
      className: "Button Button--primary",
    ...
    }, m("pre", null, this.output))), this.exitCode === 0 && this.commandOutput && this.commandOutput.length > 0 && m("div", {
      className: "Form-group"
    }, m("div", {
    ...
    }))), this.exitCode === 1 && this.errorOutput && m("div", {
      className: "Form-group"
    }, m("div", {
      className: "RegenerateImages-error"
    }, m("div", null, "Error: ", this.errorOutput)))));
  };
  _proto.regenerateImages = function regenerateImages(type) {
    var _this2 = this;
    this.regenerateType = type;
    this.loading = true;
    this.output = flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_runningCommand");
    this.commandOutput = [];
    m.redraw.sync(); // Force immediate redraw
    ...
    setTimeout(function () {
      flarum_app__WEBPACK_IMPORTED_MODULE_3___default().request({
        ...
        _this2.output = result.command + "\n";
        _this2.commandOutput = result.output;
        _this2.exitCode = result.exitCode;
        _this2.errorOutput = result.errorOutput;
        m.redraw();

        // Show success message
        flarum_app__WEBPACK_IMPORTED_MODULE_3___default().alerts.show({
          type: 'success'
        }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_success"));
      })["catch"](function (err) {
        _this2.loading = false;
        _this2.output = flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_error");
        _this2.commandOutput = [];
        _this2.exitCode = 1;
        _this2.errorOutput = err.message || flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_unknownError");
        m.redraw();

        // Show error message
        flarum_app__WEBPACK_IMPORTED_MODULE_3___default().alerts.show({
          type: 'error'
        }, flarum_app__WEBPACK_IMPORTED_MODULE_3___default().translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_error"));
      });
    }, 500); // 500ms delay to see the running message
  };
  return RegenerateImagesModal;
}((flarum_common_components_Modal__WEBPACK_IMPORTED_MODULE_1___default()));
...
/* harmony import */ var _StatsToolsBanner__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./StatsToolsBanner */ "./src/admin/components/StatsToolsBanner.js");
...
var Settings = /*#__PURE__*/function (_ExtensionPage) {
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      className: "container"
    }, m(_StatsToolsBanner__WEBPACK_IMPORTED_MODULE_7__["default"], null), m("div", {
...
/***/ "./src/admin/components/StatsToolsBanner.js":
/*!**************************************************!*\
  !*** ./src/admin/components/StatsToolsBanner.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ StatsToolsBanner)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
...
/* harmony import */ var _PurgeImagesModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./PurgeImagesModal */ "./src/admin/components/PurgeImagesModal.js");
/* harmony import */ var _RegenerateImagesModal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./RegenerateImagesModal */ "./src/admin/components/RegenerateImagesModal.js");
...
var StatsToolsBanner = /*#__PURE__*/function (_Component) {
  function StatsToolsBanner() {
    return _Component.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(StatsToolsBanner, _Component);
  var _proto = StatsToolsBanner.prototype;
  ...
  _proto.loadStats = function loadStats() {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_4___default().request({
      method: 'GET',
      url: flarum_app__WEBPACK_IMPORTED_MODULE_4___default().forum.attribute('apiUrl') + '/walsgit/discussion-cards/image-stats'
    }).then(function (result) {
      _this.stats = result;
      _this.loading = false;
      m.redraw();
  ...
  _proto.refreshStats = function refreshStats() {
    var _this2 = this;
    this.loading = true;
    flarum_app__WEBPACK_IMPORTED_MODULE_4___default().request({
      method: 'POST',
      url: flarum_app__WEBPACK_IMPORTED_MODULE_4___default().forum.attribute('apiUrl') + '/walsgit/discussion-cards/image-stats/refresh'
    }).then(function (result) {
      _this2.stats = result;
      _this2.loading = false;
      m.redraw();
      flarum_app__WEBPACK_IMPORTED_MODULE_4___default().alerts.show({
        type: 'success'
      }, flarum_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.refreshStats'));
    });
  };
  _proto.view = function view() {
    var _this3 = this;
    return m("div", {
      className: "DashboardWidget Widget StatusWidget DiscussionCardsSettings--content"
    }, m("ul", null, m("li", {
      className: "StatsWidget-item"
    }, m("span", {
      className: "StatsWidget-label"
    }, "Total images"), m("br", null), m("strong", {
      className: "StatsWidget-value"
    }, this.loading ? '…' : this.stats.totalImages)), m("li", {
      className: "StatsWidget-item"
    }, m("span", {
      className: "StatsWidget-label"
    }, "Discussions images"), m("br", null), m("strong", {
      className: "StatsWidget-value"
    }, this.loading ? '…' : this.stats.discussionImages)), m("li", {
      className: "StatsWidget-item"
    }, m("span", {
      className: "StatsWidget-label"
    }, "Discussions without images"), m("br", null), m("strong", {
      className: "StatsWidget-value"
    }, this.loading ? '…' : this.stats.discussionsWithoutImages)), m("li", {
      className: "StatsWidget-item"
    }, m("span", {
      className: "StatsWidget-label"
    }, "Unused images"), m("br", null), m("strong", {
      className: "StatsWidget-value"
    }, this.loading ? '…' : this.stats.unusedImages)), m("li", {
      className: "item-tools"
    }, m((flarum_common_components_Dropdown__WEBPACK_IMPORTED_MODULE_2___default()), {
      label: "Tools",
      icon: "fas fa-cog",
      ...
      onclick: function onclick() {
        return _this3.refreshStats();
      }
    }, "Update stats"), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default()), {
      onclick: function onclick() {
        return flarum_app__WEBPACK_IMPORTED_MODULE_4___default().modal.show(_PurgeImagesModal__WEBPACK_IMPORTED_MODULE_5__["default"]);
      }
    }, "Purge images"), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_3___default()), {
      onclick: function onclick() {
        return flarum_app__WEBPACK_IMPORTED_MODULE_4___default().modal.show(_RegenerateImagesModal__WEBPACK_IMPORTED_MODULE_6__["default"]);
      }
    }, "Regenerate images")))));
  };
  return StatsToolsBanner;
