      ...
      <div className="Modal-body">
        <div className="Form">
          ...
          <div className="Form-group">
            <label>
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLatestLabel')}
            </label>
            <div className="helpText">
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLatestHelp')}
            </div>
            <Button
          ...
          <div className="Form-group">
            <label>
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLTNOLabel')}
            </label>
            <div className="helpText">
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateLTNOHelp')}
            </div>
            <Button
              className="Button Button--primary"
          ...
          <div className="Form-group">
            <label>
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateWithoutLabel')}
            </label>
            <div className="helpText">
              {app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_regenerateWithoutHelp')}
            </div>
            <Button
              className="Button Button--primary"
      ...
      app
        .request({
          ...
          url:
            ...
            '/walsgit/discussion-cards/regenerate-images' +
            (type === 'ltno' ? '?ltno=true' : type === 'without' ? '?without=true' : ''),
        })
        .then((result) => {
          this.loading = false;
        ...
        .catch((err) => {
          ...
          this.exitCode = 1;
          this.errorOutput =
            err.message || app.translator.trans('walsgit_discussion_cards.admin.settings.statsToolsBanner.regenerateImagesModal_unknownError');
          m.redraw();
