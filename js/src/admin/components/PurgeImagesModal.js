            ...
            <div className="Modal-body">
                <div className="Form">
                    <p className="helpText">
                        {app.translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_helpText")}
                    </p>
                    ...
                    <div className="Form-group">
						...
						<div className="helpText">{app.translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteUnusedHelp")}</div>
                        <Button
                    ...
                    <div className="Form-group">
						...
						<div className="helpText">{app.translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_deleteAllHelp")}</div>
                        <Button
    ...
    purgeImages(type) {
        ...
        setTimeout(() => {
            app.request({
                ...
                app.alerts.show(
                    { type: 'error' },
                    app.translator.trans("walsgit_discussion_cards.admin.settings.statsToolsBanner.purgeImagesModal_error")
                );
            });
