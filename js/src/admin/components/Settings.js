      ...
      <div className="DiscussionCardsSettings">
        <div className="container">
          ...
          <div className="DiscussionCardsSettings--content">
            ...
            <p className="helpText">{app.translator.trans('walsgit_discussion_cards.admin.settings.general.where_info')}</p>
            ...
            <p className="helpText">{app.translator.trans('walsgit_discussion_cards.admin.settings.general.primaryCardOptions_info')}</p>
            <div className="Section">
              {this.buildSettingComponent({
                type: 'number',
                className: 'DC-Number',
            ...
            <p className="helpText">{app.translator.trans('walsgit_discussion_cards.admin.settings.general.listCardOptions_info')}</p>
            <div className="Section">
              {this.buildSettingComponent({
                type: 'switch',
            ...
            <p className="helpText">{app.translator.trans('walsgit_discussion_cards.admin.settings.general.cardOptions_info')}</p>
            <div className="Section">
              <div className="DC-DefaultImageSettings">
                <label className="DC-DefaultImageTitle">
            ...
            <div className="Section">
              <h4>
                ...
                <a href={viewsExtension.url} target="_blank" rel="noopener noreferrer">
                  {viewsExtension.name}
                </a>
                {app.translator.trans('walsgit_discussion_cards.admin.settings.general.showViews_title_or')}
                <a href={mbViewsExtension.url} target="_blank" rel="noopener noreferrer">
                  {mbViewsExtension.name}
                </a>
              ...
              <div className="helpText">
                <em>
                  {!isExtensionInstalled(viewsExtension.id) && !isExtensionInstalled(mbViewsExtension.id)
                    ...
                    : (isExtensionInstalled(viewsExtension.id) && !isExtensionActive(viewsExtension.id)) ||
                        (isExtensionInstalled(mbViewsExtension.id) && !isExtensionActive(mbViewsExtension.id))
              ...
              <h4>
                ...
                <a href={blogExtension.url} target="_blank" rel="noopener noreferrer">
                  {blogExtension.name}
                </a>
              ...
              <h4>
                ...
                <a href={repostExtension.url} target="_blank" rel="noopener noreferrer">
