...
### 3rd party extensions support (Flarum V2)
...
### 3rd party extensions support (Flarum V1)
...
- V1 developed and tested on Flarum 1.8.7 (first version released `1.0.0`) and last version `1.4.3` was developed and tested on Flarum 1.8.16.
